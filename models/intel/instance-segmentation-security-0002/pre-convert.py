...
def create_workdir(env):
    env['MODEL_TEMPLATE'] = os.path.realpath('./model_templates/coco-instance-segmentation/instance-segmentation-0002/template.yaml')
...
def main():
    ...
    # create work-dir tmp
    models_dir = Path(args.input_dir / 'model' / 'training_extensions-develop' / 'models' / 'instance_segmentation')
    with cd(models_dir):
