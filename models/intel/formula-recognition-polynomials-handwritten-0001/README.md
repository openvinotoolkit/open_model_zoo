...
Vocabulary file is located under corresponding model configuration directory, `<models_dir>/models/intel/formula-recognition-polynomials-handwritten-0001/vocab.json`. Model can predict letters, numbers and upperscript.
