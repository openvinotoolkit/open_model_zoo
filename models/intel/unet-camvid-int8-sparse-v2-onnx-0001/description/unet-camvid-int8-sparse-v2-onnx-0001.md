# unet-camvid-int8-sparse-v2-onnx-0001
...
The model output for `unet-camvid-int8-sparse-v2-onnx-0001` is the per-pixel probabilities of each input pixel belonging to one of the 12 classes of the CamVid dataset.
