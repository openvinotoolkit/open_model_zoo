...
1. Classifier, name: `detection_classes`. Contains predicted bounding-boxes classes in a range [1, 91]. The model was trained on Microsoft\* COCO dataset version with [90 categories](../../../data/dataset_classes/coco_91cl_bkgr.txt) of object, 0 class is for background.
