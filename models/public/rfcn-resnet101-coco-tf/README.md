...
R-FCN ResNet-101 model, pre-trained on [Common Objects in Context (COCO)](https://cocodataset.org/#home) dataset. Used for object detection. For details, see the [paper](https://arxiv.org/abs/1605.06409).
...
1. Image, name: `image_tensor`, shape: `1, 3, 600, 600`, format: `B, C, H, W`, where:
...
The array of summary detection information, name: `detection_output`, shape: `1, 1, 100, 7` in the format `1, 1, N, 7`, where `N` is the number of detected
