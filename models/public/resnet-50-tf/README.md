...
A copy of the license is provided in [APACHE-2.0-TensorFlow.txt](https://github.com/openvinotoolkit/open_model_zoo/blob/master/models/public/licenses/APACHE-2.0-TF-Models.txt).
