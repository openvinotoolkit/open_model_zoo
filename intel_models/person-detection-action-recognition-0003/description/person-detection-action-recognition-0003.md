# person-detection-action-recognition-classroom-0003
...
![](./person-detection-action-recognition-0003.png)
...
| Accuracy (internal test set 2)    | 89.02%                                    |
...
Where:
    ...
    - h, w - height and width of the output feature map (h=20, w=34)
