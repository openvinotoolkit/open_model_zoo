...
The model output for `ssd512-fp32-onnx-0001` is the usual object detection output for the 21 different classes present in the VOC database.
...
The quality metric (mAP) calculated on VOC07+12 validation dataset has the value of 79.38%.
