...
The model output for `unet-camvid-int8-0001` is the per-pixel probabilities of each input pixel belonging to one of the 12 classes of the CamVid dataset.
...
The quality metrics calculated on CamVid validation dataset is 71.66% mIoU.
