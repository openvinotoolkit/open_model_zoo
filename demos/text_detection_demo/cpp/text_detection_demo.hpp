...
static const char text_recognition_decoder_type_message[] = "Required. Type of the decoder, either 'simple' for SimpleDecoder or 'ctc' for CTC greedy and CTC beam search decoders.";
...
DEFINE_string(dt, "", text_recognition_decoder_type_message);
...
static void showUsage() {
    ...
    std::cout << "    -dt \"<path>\"               " << text_recognition_decoder_type_message << std::endl;
