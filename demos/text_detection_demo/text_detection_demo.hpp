...
static const char text_recognition_model_symbols_set_message[] = "Optional. Symbols set for Text Recognition model.";

/// @brief Message for central image crop argument
static const char text_central_image_crop_message[] = "Optional. If it is true, then in case of absence of Text Detector, "
                                                      "Text Reconition model will take a central image crop as an input, but not full frame. "
