...
Options:
    ...
    -m_lm "<path>"             Optional. Path to an .xml file with a trained Facial Landmarks Estimation model.
      -l "<absolute_path>"     Option \"-l\" is not supported in this version of the demo. Required for CPU custom layers. Absolute path to a shared library with the kernels implementation.
          Or
      -c "<absolute_path>"     Option \"-c\" is not supported in this version of the demo. Required for GPU custom kernels. Absolute path to an .xml file with the kernels description.
    ...
    -n_ag "<num>"              Option \"-n_ag\" is not supported in this version of the demo. Optional. Number of maximum simultaneously processed faces for Age/Gender Recognition network (by default, it is 16)
    -n_hp "<num>"              Option \"-n_hp\" is not supported in this version of the demo. Optional. Number of maximum simultaneously processed faces for Head Pose Estimation network (by default, it is 16)
    -n_em "<num>"              Option \"-n_em\" is not supported in this version of the demo. Optional. Number of maximum simultaneously processed faces for Emotions Recognition network (by default, it is 16)
    -n_lm "<num>"              Option \"-n_lm\" is not supported in this version of the demo. Optional. Number of maximum simultaneously processed faces for Facial Landmarks Estimation network (by default, it is 16)
    -dyn_ag                    Option \"-dyn_ag\" is not supported in this version of the demo. Optional. Enable dynamic batch size for Age/Gender Recognition network
    -dyn_hp                    Option \"-dyn_hp\" is not supported in this version of the demo. Optional. Enable dynamic batch size for Head Pose Estimation network
    -dyn_em                    Option \"-dyn_em\" is not supported in this version of the demo. Optional. Enable dynamic batch size for Emotions Recognition network
    -dyn_lm                    Option \"-dyn_lm\" is not supported in this version of the demo. Optional. Enable dynamic batch size for Facial Landmarks Estimation network
    ...
    -fps                       Option \"-fps\" is not supported in this version of the demo. Optional. Maximum FPS for playing video
