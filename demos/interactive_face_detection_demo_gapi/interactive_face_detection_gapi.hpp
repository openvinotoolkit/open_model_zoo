...
static const char num_batch_ag_message[] = "Option \"-n_ag\" is not supported in this version of the demo. "\
"Optional. Number of maximum simultaneously processed faces for Age/Gender Recognition network " \
"(by default, it is 16)";
// TODO: Support this option
static const char num_batch_hp_message[] = "Option \"-n_hp\" is not supported in this version of the demo. "\
"Optional. Number of maximum simultaneously processed faces for Head Pose Estimation network " \
"(by default, it is 16)";
// TODO: Support this option
static const char num_batch_em_message[] = "Option \"-n_em\" is not supported in this version of the demo. "\
"Optional. Number of maximum simultaneously processed faces for Emotions Recognition network " \
"(by default, it is 16)";
// TODO: Support this option
static const char num_batch_lm_message[] = "Option \"-n_lm\" is not supported in this version of the demo. "\
"Optional. Number of maximum simultaneously processed faces for Facial Landmarks Estimation network " \
"(by default, it is 16)";
// TODO: Support this option
static const char dyn_batch_ag_message[] = "Option \"-dyn_ag\" is not supported in this version of the demo. "\
"Optional. Enable dynamic batch size for Age/Gender Recognition network";
// TODO: Support this option
static const char dyn_batch_hp_message[] = "Option \"-dyn_hp\" is not supported in this version of the demo. "\
"Optional. Enable dynamic batch size for Head Pose Estimation network";
// TODO: Support this option
static const char dyn_batch_em_message[] = "Option \"-dyn_em\" is not supported in this version of the demo. "\
"Optional. Enable dynamic batch size for Emotions Recognition network";
// TODO: Support this option
static const char dyn_batch_lm_message[] = "Option \"-dyn_lm\" is not supported in this version of the demo. "\
"Optional. Enable dynamic batch size for Facial Landmarks Estimation network";
// TODO: Support this option
static const char performance_counter_message[] = "Option \"-pc\" is not supported in this version of the demo. "\
"Optional. Enable per-layer performance report";
// TODO: Support this option
static const char custom_cldnn_message[] = "Option \"-l\" is not supported in this version of the demo. "\
"Required for GPU custom kernels. " \
"Absolute path to an .xml file with the kernels description.";
// TODO: Support this option
static const char custom_cpu_library_message[] = "Option \"-c\" is not supported in this version of the demo. "\
...
// TODO: Support this option
static const char fps_output_message[] = "Option \"-fps\" is not supported in this version of the demo. "\
"Optional. Maximum FPS for playing video";
