...
- [VA Object Detetion C++ Demo](./va_object_detection_demo/cpp/README.md) - The demo shows how to read video frames using gstreamer and share VA surfaces data with input blobs without copying. Demo uses object detection models.
