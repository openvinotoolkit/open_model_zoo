...
class YoloV4(YOLO):
    ...
    def __init__(self, ie, model_adapter, resize_type='fit_to_window_letterbox',
                 labels=None, threshold=0.5, iou_threshold=0.5,
                 anchors=None, masks=None):
        self.anchors = anchors
        self.masks = masks
        super().__init__(ie, model_adapter, resize_type,
                         labels=labels, threshold=threshold, iou_threshold=iou_threshold)
...
class YOLOF(YOLO):
    ...
    def __init__(self, ie, model_adapter, resize_type='standard',
                 labels=None, threshold=0.5, iou_threshold=0.5):
        super().__init__(ie, model_adapter, resize_type,
                         labels=labels, threshold=threshold, iou_threshold=iou_threshold)
...
class YOLOX(DetectionModel):
    def __init__(self, ie, model_adapter, labels=None, threshold=0.5, iou_threshold=0.65):
        super().__init__(ie, model_adapter, labels=labels,
