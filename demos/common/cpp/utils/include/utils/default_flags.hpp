...
DEFINE_uint32(limit, 1000, output_limit_message);
...
static const char output_limit_message[] = "Optional. Number of frames to store in output. If 0 is set, all frames are stored.";
