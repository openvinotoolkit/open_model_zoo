...
namespace {
std::unordered_set<MonitorType> strKeysToMonitorSet(const std::string& keys) {
    std::unordered_set<MonitorType> enabledMonitors;
...
Presenter::Presenter(std::unordered_set<MonitorType> enabledMonitors,
        int yPos,
        cv::Size graphSize,
