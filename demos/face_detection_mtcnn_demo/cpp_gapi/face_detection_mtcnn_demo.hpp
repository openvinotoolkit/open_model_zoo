...
static const char mtcnn_p_model_message[] =
    "Required. Path to an .xml file with a trained OpenVINO MTCNN P (Proposal) detection model.";
static const char mtcnn_r_model_message[] =
    "Required. Path to an .xml file with a trained OpenVINO MTCNN R (Refinement) detection model.";
static const char mtcnn_o_model_message[] =
    "Required. Path to an .xml file with a trained OpenVINO MTCNN O (Output) detection model.";
static const char target_device_message_p[] =
    "Optional. Target device for MTCNN P network. "
    "The demo will look for a suitable plugin for a specified device. Default value is \"CPU\".";
static const char target_device_message_r[] =
    "Optional. Target device for MTCNN R network. "
    "The demo will look for a suitable plugin for a specified device. Default value is \"CPU\".";
static const char target_device_message_o[] =
    "Optional. Target device for MTCNN O network. "
    "The demo will look for a suitable plugin for a specified device. Default value is \"CPU\".";
static const char thresh_output_message[] = "Optional. MTCNN confidence threshold. The default value is 0.7.";
static const char queue_capacity_message[] =
    "Optional. Streaming executor queue capacity. Calculated automaticaly if 0.";
