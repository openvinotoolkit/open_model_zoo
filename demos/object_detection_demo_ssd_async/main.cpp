...
int main(int argc, char *argv[]) {
    try {
        ...
        auto userSpecifiedConfig = createConfig(deviceString, FLAGS_nstreams, FLAGS_nthreads);
        auto minLatencyConfig = createConfig(deviceString, FLAGS_nstreams, FLAGS_nthreads, true);;
        // -----------------------------------------------------------------------------------------------------
        ...
        ExecutableNetwork userSpecifiedExecNetwork = ie.LoadNetwork(cnnNetwork, deviceString, userSpecifiedConfig);
        ExecutableNetwork minLatencyExecNetwork = ie.LoadNetwork(cnnNetwork, deviceString, minLatencyConfig);
        // -----------------------------------------------------------------------------------------------------
