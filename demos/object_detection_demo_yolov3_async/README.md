...
> **NOTE:** This topic describes usage of C++ implementation of the Object Detection YOLO* V3 Demo Async API . For the Python* implementation, refer to [Object Detection YOLO* V3 Python* Demo, Async API Performance Showcase](https://github.com/opencv/open_model_zoo/tree/2019/demos/object_detection_demo_yolov3_async/README.md).

To learn more about Async API features, please refer to [Object Detection for SSD Demo, Async API Performance Showcase](https://github.com/opencv/open_model_zoo/tree/2019/demos/object_detection_demo_ssd_async/README.md).
