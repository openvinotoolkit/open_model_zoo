...
/// @brief Defines parameter for pose estimation model file <br>
/// It is a required parameter
DEFINE_string(m, "", pose_estimation_model_message);
...
static void showUsage() {
    ...
    std::cout << "    -m \"<path>\"                " << pose_estimation_model_message << std::endl;
