...
1. Put images containing tight crops of frontal-oriented faces (or use `-crop_gallery` key for the demo) to a separate empty folder. Each identity couldn't have multiple images. Name images as `id_name0.png, id_name1.png, ...`.
