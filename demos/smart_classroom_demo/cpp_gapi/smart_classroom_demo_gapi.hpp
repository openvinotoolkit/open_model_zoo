...
static const char person_action_detection_model_message[] =
    "Required. Path to the Person/Action Detection Retail model (.xml) file.";
...
static const char facial_landmarks_model_message[] =
    "Required. Path to the Facial Landmarks Regression Retail model (.xml) file.";
static const char face_reid_model_message[] = "Required. Path to the Face Reidentification Retail model (.xml) file.";
static const char target_device_message_action_detection[] =
    "Optional. Specify the target device for Person/Action Detection Retail "
    "(the list of available devices is shown below). Default value is CPU. "
    "The application looks for a suitable plugin for the specified device.";
static const char target_device_message_face_detection[] =
    "Optional. Specify the target device for Face Detection Retail "
    "(the list of available devices is shown below). Default value is CPU. "
    "The application looks for a suitable plugin for the specified device.";
static const char target_device_message_landmarks_regression[] =
    "Optional. Specify the target device for Landmarks Regression Retail "
    "(the list of available devices is shown below). Default value is CPU. "
    "The application looks for a suitable plugin for the specified device.";
static const char target_device_message_face_reid[] =
    "Optional. Specify the target device for Face Reidentification Retail "
    "(the list of available devices is shown below). Default value is CPU. "
    "The application looks for a suitable plugin for the specified device.";
...
static const char teacher_id_message[] =
    "Optional. ID of a teacher. You must also set a faces gallery parameter (-fg) to use it.";
...
static const char target_actions_num_message[] =
    "Optional. Number of first K students. If this parameter is positive, "
...
static const char face_threshold_registration_output_message[] =
    "Optional. Probability threshold for face detections during database registration.";
static const char min_size_fr_reg_output_message[] =
    "Optional. Minimum input size for faces during database registration.";
