...
static const char detection_output_layer_name_message[] = "The name of detection output layer (default: detection_output)";

/// @brief message for masks layer name argument
static const char masks_layer_name_message[] = "The name of masks layer (default: masks)";
