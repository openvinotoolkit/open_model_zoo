...
DEFINE_bool(h, false, help_message);
    ...
    DEFINE_string(i, "../../../demos/end2end_video_analytics/test_content/video/cars_1920x1080.h264", image_message);
    /// \brief Define parameter for set model file <br>
    /// It is a required parameter
    DEFINE_string(m, "", model_message);
    /// \brief Define parameter for labels file <br>
    /// It is a required parameter
    DEFINE_string(l, "../../../demos/end2end_video_analytics/test_content/IR/SSD/pascal_voc_classes.txt", labels_message);
#else
    /// \brief Define parameter for video file <br>
    /// It is a required parameter
