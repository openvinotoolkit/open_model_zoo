...
static const char sr_device_message[] = "Optional. Target device for Super Resolution network (the list of available devices is shown below). "
                                            "The demo will look for a suitable plugin for a specified device. Default value is \"CPU\".";
static const char thr_conf_yolov4_message[] = "Optional. YOLO v4 Tiny confidence threshold.";
static const char thr_box_iou_yolov4_message[] = "Optional. YOLO v4 Tiny box IOU threshold.";
static const char advanced_pp_message[] = "Optional. Use advanced post-processing for the YOLO v4 Tiny.";
static const char apply_sr_message[] = "Optional. Use Super Resolution post processing model.";
...
DEFINE_string(d_sr, "CPU", sr_device_message);
...
static void showUsage() {
    std::cout << std::endl;
    std::cout << "smart_framing_demo_gapi [OPTION]" << std::endl;
    ...
    std::cout << "    -m_yolo \"<path>\"            " << yolo_model_message << std::endl;
    std::cout << "    -at_sr \"<type>\"             " << sr_at_message << std::endl;
    std::cout << "    -m_sr \"<path>\"              " << sr_model_message << std::endl;
    std::cout << "    -kernel_package \"<string>\"  " << kernel_package_message << std::endl;
    std::cout << "    -d_yolo \"<device>\"          " << yolo_device_message << std::endl;
    std::cout << "    -d_sr \"<device>\"            " << sr_device_message << std::endl;
