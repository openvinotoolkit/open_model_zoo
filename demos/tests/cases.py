    ...
    CppDemo(name='pedestrian_tracker_demo',
        ...
        [
            *combine_cases(
            ...
            TestCase(options={'-person_label': '0', '-at': 'yolo', '-m_det': 'yolo-v3-tf'}),
            TestCase(options={'-person_label': '0', '-at': 'centernet', '-m_det': 'ctdet_coco_dlav0_512'}),
            TestCase(options={'-person_label': '1', '-at': 'ssd', '-m_det': 'retinanet-tf'}),
        ],
        single_option_cases('-m_reid',
            ModelArg('person-reidentification-retail-0277'),
            ModelArg('person-reidentification-retail-0286'),
