...
def _test_metric_wrapper(metric_cls, dataset=None, **kwargs):
...
class TestBoxMatch:
    ...
    def test_multiple_detections_with_ignore_difficult_and_not_allow_multiple_matches_per_ignored(self):
        ...
        tp, fp, _, n = bbox_match(gt, pred, 0, overlap_evaluator, ignore_difficult=True, allow_multiple_matches_per_ignored=False)
        assert n == 0
        assert tp[0] == 0
        assert tp[1] == 0
        assert fp[0] == 0
...
class TestRecall:
    def test_one_object(self, dataset):
        gt = make_representation(["0 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5"], score=1)
        metric = _test_metric_wrapper(Recall, dataset)
        assert 1 == metric(gt, pred)[0]
        assert metric.meta.get('names') == ['dog']

    def test_two_objects(self, dataset):
        ...
        assert 1 == _test_metric_wrapper(Recall, dataset)(gt, pred)[0]

    def test_false_positive(self, single_class_dataset):
    ...
    def test_false_negative(self, single_class_dataset):
    ...
    def test_repeatant_detectios(self, single_class_dataset):
        gt = make_representation(["0 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5; 0 0 0 5 5"], score=1)
    ...
    def test_no_warnings_in_recall_calculation(self, multi_class_dataset):
    ...
    def test_on_dataset_without_background(self, multi_class_dataset_without_background):
        gt = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], score=1)
...
class TestMAP:
    ...
    def test_no_warnings_in_map_calculation(self, multi_class_dataset):
        gt = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], score=1)
    ...
    def test_perfect_detection(self, multi_class_dataset):
        gt = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], score=1)
    ...
    def test_one_false_alarm(self, multi_class_dataset):
    ...
    def test_zero_detection(self, multi_class_dataset):
    ...
    def test_no_detections_warn_user_warning(self, multi_class_dataset):
        gt = make_representation(["0 0 0 5 5; 1 10 10 20 20"], is_ground_truth=True)
    ...
    def test_detection_on_dataset_without_background(self, multi_class_dataset_without_background):
        gt = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], is_ground_truth=True)
        pred = make_representation(["0 0 0 5 5; 1 10 10 20 20", "1 0 0 5 5"], score=1)
