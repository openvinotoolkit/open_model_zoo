...
class XML2DetectionAdapter(Adapter):
    ...
    def process(self, tree, identifiers=None):
        ...
        for frames in tree.getroot():
            for frame in frames:
                ...
                for prediction in frame:
                    is_ignored = prediction.find('is_ignored')
                ...
                res[identifier] = DetectionPrediction(identifier, labels, scores, x_mins, y_mins, x_maxs, y_maxs)
