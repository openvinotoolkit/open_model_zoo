...
class NMS(Postprocessor):
    ...
    def validate_config(self):
        ...
        nms_config_validator = _NMSConfigValidator(self.__provider__,
                                                   on_extra_argument=_NMSConfigValidator.ERROR_ON_EXTRA_ARGUMENT)
    ...
    def process_image(self, annotations, predictions):
        for prediction in predictions:
            ...
            prediction.remove([i for i in range(len(prediction.x_mins)) if i not in keep])
