...
class CorrectYoloV2Boxes(Postprocessor):
    ...
    def validate_config(self):
        ...
        clip_config_validator = _CorrectYoloV2BoxesConfigValidator(self.__provider__)
    ...
    def process_image(self, annotation, prediction):
        ...
        for prediction_ in prediction:
            for i, (x0, y0, x1, y1) in enumerate(zip(prediction_.x_mins, prediction_.y_mins,
                                                     prediction_.x_maxs, prediction_.y_maxs)):
