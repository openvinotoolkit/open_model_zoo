...
class Detection(BaseRepresentation):
    ...
    def remove(self, indexes):
        ...
        id_difficult = 0
        id_removed = 0
        while id_difficult < len(difficult_boxes) and id_removed < len(indexes):
            if difficult_boxes[id_difficult] < indexes[id_removed]:
                new_difficult_boxes.append(difficult_boxes[id_difficult] - decrementor)
                id_difficult += 1
            else:
                decrementor += 1
                id_removed += 1
