...
class BasePresenter(ClassProvider):
    ...
    def write_result(self, evaluation_result, output_callback=None):
...
class ScalarPrintPresenter(BasePresenter):
    ...
    def write_result(self, evaluation_result: EvaluationResult, output_callback=None):
