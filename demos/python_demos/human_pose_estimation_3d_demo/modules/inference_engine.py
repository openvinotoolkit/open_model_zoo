...
class InferenceEngine:
    def __init__(self, net_model_xml_path, device, stride):
        ...
        self.exec_net = self.ie.load_network(self.net, device, create_default_config(device), 1)
    ...
    def infer(self, img):
        ...
        if h != img.shape[0] or w != img.shape[1]:
            ...
            self.exec_net = self.ie.load_network(self.net, self.device, create_default_config(self.device), 1)
