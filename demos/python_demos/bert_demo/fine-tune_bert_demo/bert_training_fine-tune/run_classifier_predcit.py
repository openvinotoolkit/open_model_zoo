...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.variable_scope("loss"):
    ...
    probabilities = tf.nn.softmax(logits, axis=-1,name='softmax_output')
...
#-----------------------------------prepare data from moive review---------------------------
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    def getPrediction(in_sentences):
      ...
      return [(sentence, prediction['probabilities'], labels[np.argmax(prediction['probabilities'])]) for sentence, prediction in zip(in_sentences, predictions)]
