...
def build_argparser():
    ...
    args.add_argument('-at', '--architecture_type', help='Required. Specify model\' architecture type.',
                      type=str, required=True, choices=('ssd', 'yolo', 'yolov4', 'yolov4-tiny', 'faceboxes', 'centernet', 'ctpn',
...
def get_model(ie, args):
    if args.architecture_type == 'ssd':
        ...
        return models.YoloV4(ie, args.model, labels=args.labels,
                             threshold=args.prob_threshold, keep_aspect_ratio=args.keep_aspect_ratio)
    elif args.architecture_type == 'yolov4-tiny':
        return models.YoloV4Tiny(ie, args.model, labels=args.labels,
                                 threshold=args.prob_threshold, keep_aspect_ratio=args.keep_aspect_ratio)
