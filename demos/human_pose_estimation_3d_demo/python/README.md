...
Refer to [Open Model Zoo Demos](../../README.md) for instructions on how to build it and prepare the environment for running the demo. Once demo built with Python extension modules, add path demo build folder to `PYTHONPATH` environment variable.
