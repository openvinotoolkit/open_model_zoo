...
def main():
    ...
    if args.shape:
        log.debug("\tReshaped model from {} to {}".format(input_info[input_name].input_data.shape, args.shape))
    ...
    log.info('Loaded model {} to {}'.format(args.path_to_model, args.device))
    del ie_network
