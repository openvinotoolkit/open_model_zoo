...
static const char eyes_state_model_message[] = "Optional. Path to an .xml file with a trained Eye State Estimation model.";
...
static const char target_device_message_ey[] = "Optional. Target device for Eye State Estimation network "
                                               "(the list of available devices is shown below). Default value is CPU. Use \"-d HETERO:<comma-separated_devices_list>\" format to specify HETERO plugin. "
                                               "The demo will look for a suitable plugin for device specified.";
...
static const char num_batch_lm_message[] = "Optional. Number of maximum simultaneously processed faces for Facial Landmarks Estimation network "
                                           "(by default, it is 16)";
static const char num_batch_ey_message[] = "Optional. Number of maximum simultaneously processed faces for Eye State Estimation network "
                                           "(by default, it is 16)";                                          
...
static const char dyn_batch_ey_message[] = "Optional. Enable dynamic batch size for Eye State Estimation network";
...
DEFINE_string(m_ey, "", eyes_state_model_message);
...
DEFINE_string(d_ey, "CPU", target_device_message_ey);
...
DEFINE_uint32(n_ey, 16, num_batch_ey_message);
DEFINE_bool(dyn_ey, false, dyn_batch_ey_message);
