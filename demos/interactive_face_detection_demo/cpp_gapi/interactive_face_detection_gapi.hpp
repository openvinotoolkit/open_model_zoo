...
constexpr char input_video_message[] = "Required. Path to a video file (specify \"cam\" to work with camera).";
...
constexpr char target_device_message[] = "Optional. Target device for Face Detection network (the list of available devices is shown below). "
                                            "Default value is CPU. The demo will look for a suitable plugin for a specified device.";
DEFINE_string(d, "CPU", target_device_message);

constexpr char target_device_message_ag[] = "Optional. Target device for Age/Gender Recognition network (the list of available devices is shown below). "
                                               "Default value is CPU. The demo will look for a suitable plugin for a specified device.";
DEFINE_string(d_ag, "CPU", target_device_message_ag);

constexpr char target_device_message_hp[] = "Optional. Target device for Head Pose Estimation network (the list of available devices is shown below). "
                                               "Default value is CPU. The demo will look for a suitable plugin for a specified device.";
DEFINE_string(d_hp, "CPU", target_device_message_hp);

constexpr char target_device_message_em[] = "Optional. Target device for Emotions Recognition network (the list of available devices is shown below). "
                                               "Default value is CPU. The demo will look for a suitable plugin for a specified device.";
DEFINE_string(d_em, "CPU", target_device_message_em);

constexpr char target_device_message_lm[] = "Optional. Target device for Facial Landmarks Estimation network "
...
constexpr char target_device_message_am[] = "Optional. Target device for Antispoofing Classification network (the list of available devices is shown below). "
...
constexpr char loop_output_message[] = "Optional. Enable playing video on a loop";
