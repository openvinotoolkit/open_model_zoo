...
To run the demo, you can use public or Intel pre-trained models. Models can be downloaded and if necessary converted to Inference Engine format using the OpenVINO [Model Downloader and other automation tools](../../../tools/downloader/README.md) as shown in examples below. The models which are supported by the demo listed in [models.lst](./models.lst) file.
