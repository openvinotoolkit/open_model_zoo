...
/**
* \brief The entry point for the Inference Engine hand Pose Estimation demo application
* \file hand_pose_estimation_demo/main.cpp
* \example hand_pose_estimation_demo/main.cpp
*/

#include <vector>
#include <inference_engine.hpp>
#include <samples/ocv_common.hpp>
#include "hand_pose_estimation_demo.hpp"
...
int main(int argc, char* argv[]) {
    try {
        ...
        handPoseEstimator estimator(FLAGS_m, FLAGS_d, FLAGS_pc);
        //cv::VideoCapture cap;
        ...
        do {
            ...
            std::vector<handPose> poses = estimator.estimate(image);
            ...
            cv::imshow("ICV hand Pose Estimation", image);
