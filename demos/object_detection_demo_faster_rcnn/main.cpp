...
int main(int argc, char *argv[]) {
    try {
        ...
        std::cout << ie.GetVersions(deviceString) << std::endl;
        // -----------------------------------------------------------------------------------------------------
        ...
        ExecutableNetwork executable_network = ie.LoadNetwork(network, deviceString, createDefaultConfig(deviceString));
        // -----------------------------------------------------------------------------------------------------
