...
* `class_aware_nms` - class-aware non-maximum suppression. Class-aware nms is applied to all detected classes separately. The supported representations and parameters are the same as for the `nms`.
