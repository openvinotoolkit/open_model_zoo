...
More details about custom evaluations can be found in the [related section](./tools/accuracy_checker/accuracy_checker/evaluators/custom_evaluators/README.md).
